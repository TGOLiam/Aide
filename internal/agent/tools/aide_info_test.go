...
func TestCrushInfo_ConfigFiles(t *testing.T) {
	...
	cfg := config.NewTestStore(
		...
		"/home/user/.config/aide/aide.json",
		"/project/.aide/aide.json",
	)
	output := buildCrushInfo(cfg, nil, nil, nil, nil)
	require.Contains(t, output, "[config_files]")
	require.Contains(t, output, "/home/user/.config/aide/aide.json")
	require.Contains(t, output, "/project/.aide/aide.json")
}
...
func TestCrushInfo_Options(t *testing.T) {
	...
	cfg := config.NewTestStore(&config.Config{
		...
		Options: &config.Options{
			DataDirectory:        "/Users/user/project/.aide",
			Debug:                true,
	...
	require.Contains(t, output, "data_directory = /Users/user/project/.aide")
...
func TestCrushInfo_ConfigStaleness_Clean(t *testing.T) {
	...
	dir := t.TempDir()
	configPath := filepath.Join(dir, "aide.json")
...
func TestCrushInfo_Skills_MixedLoadedUnloaded(t *testing.T) {
	...
	require.Contains(t, output, "aide-config = builtin, loaded")
...
func TestCrushInfo_Skills_DisabledSkills(t *testing.T) {
	...
	require.Contains(t, output, "aide-config = builtin, unloaded")
