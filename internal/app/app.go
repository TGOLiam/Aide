...
import (
	...
	"github.com/liamb/opencode/aide/internal/update"
...
type App struct {
	...
	// subscribers (notably `aide run` in client/server mode) can
...
// for `aide run`. A lossy fan-in here can drop the only terminal
