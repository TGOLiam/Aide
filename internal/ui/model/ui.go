...
import (
	...
	agenttools "github.com/liamb/aide/internal/agent/tools"
	...
	"github.com/liamb/aide/internal/ui/completions"
	"github.com/liamb/aide/internal/ui/dialog"
	fimage "github.com/liamb/aide/internal/ui/image"
	"github.com/liamb/aide/internal/ui/logo"
	"github.com/liamb/aide/internal/ui/notification"
...
func (m *UI) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case app.UpdateAvailableMsg:
		text := fmt.Sprintf("Aide update available: v%s → v%s.", msg.CurrentVersion, msg.LatestVersion)
		if msg.IsDevelopment {
			text = fmt.Sprintf("This is a development version of Aide. The latest version is v%s.", msg.LatestVersion)
		}
		ttl := 10 * time.Second
