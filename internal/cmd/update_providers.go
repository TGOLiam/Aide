...
aide update-providers

# Update Catwalk providers from a custom URL
aide update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
aide update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
aide update-providers embedded

# Update Hyper provider information
aide update-providers --source=hyper

# Update Hyper from a custom URL
aide update-providers --source=hyper https://hyper.example.com
`,
